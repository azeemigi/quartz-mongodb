package com.mulesoft.quartz.mongo.utils;
...
public class JobKeyBox {
    ...
    public static final String TRIGGER_KEY_INDEX = "keyIndex";
    ...
    public static final String SIMPLE_TRIGGER_REPEAT_COUNT = "repeatCount";
    public static final String SIMPLE_TRIGGER_REPEAT_INTERVAL = "repeatInterval";
    public static final String SIMPLE_TRIGGER_TIMES_TRIGGERED = "timesTriggered";
